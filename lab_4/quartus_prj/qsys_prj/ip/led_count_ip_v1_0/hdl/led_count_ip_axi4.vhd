-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\d57w762\Desktop\lab4\hdlsrc\hdlcoder_led_blinking_4bit\led_count_ip_axi4.vhd
...
END led_count_ip_axi4;


ARCHITECTURE rtl OF led_count_ip_axi4 IS
  ...
  COMPONENT led_count_ip_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : led_count_ip_axi4_module
    USE ENTITY work.led_count_ip_axi4_module(rtl);
...
BEGIN
  ...
  u_led_count_ip_axi4_module_inst : led_count_ip_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
