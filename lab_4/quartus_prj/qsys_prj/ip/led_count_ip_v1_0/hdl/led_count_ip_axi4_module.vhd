-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\d57w762\Desktop\lab4\hdlsrc\hdlcoder_led_blinking_4bit\led_count_ip_axi4_module.vhd
...
ENTITY led_count_ip_axi4_module IS
...
END led_count_ip_axi4_module;


ARCHITECTURE rtl OF led_count_ip_axi4_module IS

  -- Component Declarations
  COMPONENT led_count_ip_rdfifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT led_count_ip_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : led_count_ip_rdfifo_data
    USE ENTITY work.led_count_ip_rdfifo_data(rtl);

  FOR ALL : led_count_ip_rdfifo_last
    USE ENTITY work.led_count_ip_rdfifo_last(rtl);
  ...
  SIGNAL AXI4_RID_tmp                     : unsigned(11 DOWNTO 0);  -- ufix12
...
BEGIN
  u_led_count_ip_rdfifo_data_inst : led_count_ip_rdfifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_led_count_ip_rdfifo_last_inst : led_count_ip_rdfifo_last
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  axi4_output : PROCESS (axi4_wstate, axi4_wid, axi4_waddr, axi4_waddr_inc, axi4_awtransfer,
       axi4_wtransfer, axi4_rstate, axi4_rid_1, axi4_raddr, axi4_raddr_inc,
       axi4_rlen, axi4_ar_transfer, axi4_rlast_1, axi4_rd_active,
       AXI4_AWID_unsigned, AXI4_AWADDR_unsigned, AXI4_AWBURST_unsigned,
       AXI4_AWVALID, AXI4_WLAST, AXI4_WVALID, AXI4_BREADY, AXI4_ARID_unsigned,
       AXI4_ARADDR_unsigned, AXI4_ARLEN_unsigned, AXI4_ARBURST_unsigned,
       AXI4_ARVALID, fifo_afull_data)
    VARIABLE out6 : std_logic;
  ...
  BEGIN
    ...
    CASE axi4_rstate IS
      WHEN "00000000" =>
        out6 := hdlcoder_to_stdlogic(axi4_wstate = to_unsigned(16#00000000#, 8)) AND ( NOT awvalid);
  ...
  AXI4_RID <= std_logic_vector(AXI4_RID_tmp);
