-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\d57w762\Desktop\lab4\hdlsrc\hdlcoder_led_blinking_4bit\led_count_ip_rdfifo_last.vhd
...
ENTITY led_count_ip_rdfifo_last IS
...
END led_count_ip_rdfifo_last;


ARCHITECTURE rtl OF led_count_ip_rdfifo_last IS

  -- Component Declarations
  COMPONENT led_count_ip_rdfifo_last_classic
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : led_count_ip_rdfifo_last_classic
    USE ENTITY work.led_count_ip_rdfifo_last_classic(rtl);
...
BEGIN
  u_led_count_ip_rdfifo_last_classic_inst : led_count_ip_rdfifo_last_classic
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
