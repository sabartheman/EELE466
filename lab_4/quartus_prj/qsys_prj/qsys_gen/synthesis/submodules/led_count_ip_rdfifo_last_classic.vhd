-- -------------------------------------------------------------
-- 
-- File Name: C:\Users\d57w762\Desktop\lab4\hdlsrc\hdlcoder_led_blinking_4bit\led_count_ip_rdfifo_last_classic.vhd
...
ENTITY led_count_ip_rdfifo_last_classic IS
...
END led_count_ip_rdfifo_last_classic;


ARCHITECTURE rtl OF led_count_ip_rdfifo_last_classic IS

  -- Component Declarations
  COMPONENT led_count_ip_rdfifo_last_classic_ram_16x1b
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : led_count_ip_rdfifo_last_classic_ram_16x1b
    USE ENTITY work.led_count_ip_rdfifo_last_classic_ram_16x1b(rtl);
...
BEGIN
  ...
  u_led_count_ip_rdfifo_last_classic_ram_16x1b : led_count_ip_rdfifo_last_classic_ram_16x1b
    PORT MAP( clk => clk,
              enb => enb,
