...
module  mult_fl01
	...
	assign
		wire_sft10a_in = {w317w, {w317w, {w317w, {w317w, {w_sum_node10w[62], {w_lone_sum_node11w[7], {w_lone_sum_node11w[6], {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {2{w317w}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w317w, {w_sum_node10w[47], {w_sum_node10w[46], {w_lone_sum_node11w[5], {w_lone_sum_node11w[4], {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81:80]}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w317w, {w317w, {w317w, {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25:24]}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w317w, {w317w, {w317w, {w317w, {w317w, {w_lone_sum_node11w[3], {w_lone_sum_node11w[2], {w_lone_sum_node11w[1], {w_lone_sum_node11w[0], {2{w317w}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft3a_in = {w317w, {w317w, {w_sum_node10w[95], {w_sum_node10w[94], {w_lone_sum_node11w[11], {w_lone_sum_node11w[10], {w_sum_node10w[63], {w_sum_node10w[76], {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[15], {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft8a_in = {w317w, {w_sum_node10w[79], {w_sum_node10w[78], {w_lone_sum_node11w[9], {w_lone_sum_node11w[8], {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49:48]}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w317w, {w317w, {w317w, {w_sum_node10w[91], {w_sum_node10w[90], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35:34]}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[13:0]},
		datab_node = {dataa[12:0]},
		final_result_node = {w541w[26:0]},
		result = {final_result_node[26:0]},
		w317w = 1'b0,
		w541w = {wire_sft6a_out[25:24], wire_sft6a_out[23:22], wire_sft6a_out[21:20], wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
