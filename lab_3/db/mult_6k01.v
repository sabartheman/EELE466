//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=8 LPM_WIDTHB=18 LPM_WIDTHP=26 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_6k01
	...
	assign
		wire_sft10a_in = {w225w, {w225w, {w225w, {w225w, {w225w, {w225w, {w225w, {w225w, {w225w, {w225w, {w225w, {w225w, {w225w, {w225w, {w225w, {2{w225w}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft8a_in = {w225w, {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61:60]}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w225w, {w225w, {w225w, {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43:42]}}}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[17:0]},
		datab_node = {dataa[7:0]},
		final_result_node = {w394w[25:0]},
		result = {final_result_node[25:0]},
		w225w = 1'b0,
		w394w = {wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[17:0]} & {18{w_le_datab_node8w[7]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[6]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[5]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[4]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[3]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[2]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[1]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[0]}})},
